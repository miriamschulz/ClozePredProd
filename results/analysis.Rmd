...
if (plot_inidividual_items_surprisal == TRUE) {
  ...
  for (i in unique(as.numeric(as.character(dat_plot$Item)))) {
    ...
    p <- ggplot(dat_plot_item_long,
      ...
      # # Add gpt2-large surprisal lines and points
      # geom_line(aes(y = Gpt2Large_scaled), color = "gold",
      #           linewidth = 1, linetype = "solid") +
      # geom_point(aes(y = Gpt2Large_scaled), color = "gold", size = 2) +
      # 
      # # Add GPTNeo surprisal lines and points
      # geom_line(aes(y = GPTNeo_scaled), color = "orange",
      #           linewidth = 1, linetype = "solid") +
      # geom_point(aes(y = GPTNeo_scaled), color = "orange", size = 2) +
      # 
      # # Add Llama surprisal lines and points
      # geom_line(aes(y = Llama_scaled), color = "darkorange3",
      #           linewidth = 1, linetype = "solid") +
      # geom_point(aes(y = Llama_scaled), color = "darkorange3", size = 2) +
...
if (plot_inidividual_items_surprisal == TRUE) {
  ...
  for (i in unique(as.numeric(as.character(dat_plot$Item)))) {
    ...
    # Rescale surprisal to RTs
    dat_plot_item <- dat_plot_item %>%
      mutate(Gpt2Large_scaled = scales::rescale(Gpt2Large,
                                                to = range(RT, na.rm = TRUE)))
    ...
    p <- ggplot(dat_plot_item,
      ...
      geom_line(aes(y = Gpt2Large_scaled, color = ExpCondition),
                linewidth = 1, linetype = "solid") +
      geom_point(aes(y = Gpt2Large_scaled, color = ExpCondition), size = 2) +
      ...
      labs(color = "Expectancy",
           title = paste0("Reading Times & Surprisal: Item ", item_no_char)) +
      ...
      ylab("Reading Time (ms)") +
      # Secondary Y-Axis
      scale_y_continuous(sec.axis = sec_axis(~ ., name = "gpt2-large")) +
