...
save(dat, file = "results_preprocessed_filtered_targetregions.RData")
save(dat_all, file = "results_preprocessed_filtered_all.RData")
```
...
```{r rt-subj-plot, eval = generate_main_plots, fig.height=10, fig.width=15}
dat_plot <- summarySE(dat,
                      measurevar="RT",
...
```{r rt-item-plot, eval = generate_main_plots, fig.height=10, fig.width=15}
# Generate a summary data frame including the SE:
dat_plot <- summarySE(dat,
                      measurevar="RT",
                      groupvars=c("Region", "ExpCondition",
...
```{r rt-targetfreq-plot, eval = generate_main_plots, fig.height=7, fig.width=12}
# Generate a summary data frame including the SE:
dat_plot <- dat %>% 
