...
dat_plot <- summarySE(dat,
                      ...
                      na.rm=T)
dat_plot <- droplevels(dat_plot)
dat_plot$Task_Condition <- interaction(dat_plot$ExpCondition, dat_plot$Task)
...
## Line plot by experimental half & task
